...
class Roundabout(bs.Map):
    ...
    def on_preload(cls) -> Any:
        data: dict[str, Any] = {
            ...
            "mesh_bg_tex": bs.gettexture("natureBackgroundColor"),
            "collide_bg": bs.getcollisionmesh("natureBackgroundCollide"),
            "railing_collision_mesh": (bs.getcollisionmesh("roundaboutLevelBumper")),
            "bg_material": bs.Material(),
        }
        data["bg_material"].add_actions(
            actions=("modify_part_collision", "friction", 10.0)
...
class MonkeyFace(bs.Map):
    ...
    def on_preload(cls) -> Any:
        data: dict[str, Any] = {
            ...
            "mesh_bg_tex": bs.gettexture("natureBackgroundColor"),
            "collide_bg": bs.getcollisionmesh("natureBackgroundCollide"),
            "railing_collision_mesh": (bs.getcollisionmesh("monkeyFaceLevelBumper")),
            "bg_material": bs.Material(),
        }
        data["bg_material"].add_actions(
            actions=("modify_part_collision", "friction", 10.0)
...
class CragCastle(bs.Map):
    ...
    def on_preload(cls) -> Any:
        data: dict[str, Any] = {
            ...
            "bgtex": bs.gettexture("menuBG"),
            "bgmesh": bs.getmesh("thePadBG"),
            "railing_collision_mesh": (bs.getcollisionmesh("cragCastleLevelBumper")),
...
class TowerD(bs.Map):
    ...
    def on_preload(cls) -> Any:
        data: dict[str, Any] = {
            ...
            "bgtex": bs.gettexture("menuBG"),
            "bgmesh": bs.getmesh("thePadBG"),
            "player_wall_collision_mesh": bs.getcollisionmesh("towerDPlayerWall"),
...
class Courtyard(bs.Map):
    ...
    def on_preload(cls) -> Any:
        data: dict[str, Any] = {
            ...
            "bgtex": bs.gettexture("menuBG"),
            "bgmesh": bs.getmesh("thePadBG"),
            "player_wall_collision_mesh": (bs.getcollisionmesh("courtyardPlayerWall")),
            "player_wall_material": bs.Material(),
        }
