...
class GraphicsSettingsWindow(bui.MainWindow):
    ...
    def __init__(
        ...
        PopupMenu(
            ...
            choices_disabled=(
                ["Higher", "High"] if bui.get_max_graphics_quality() == "Medium" else []
            ),
            choices_display=[
        ...
        if show_resolution:
            ...
            if app.classic.platform == "android":
                ...
                if app.classic.subplatform == "cardboard":
                    ...
                    current_res_android = bui.app.config.resolve("Resolution (Android)")
                    resolution_popup = PopupMenu(
                        parent=self._root_widget,
                        position=(h_offs + 60, v - 50),
                        width=120,
    ...
    def _on_max_fps_return_press(self) -> None:
        self._apply_max_fps()
        bui.containerwidget(edit=self._root_widget, selected_child=cast(bui.Widget, 0))
