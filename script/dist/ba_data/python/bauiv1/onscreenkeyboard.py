...
class OnScreenKeyboardWindow(Window):
        ...
        for row_num, row in enumerate(chars):
            ...
            if row_num == 2:
                ...
                if self._space_button is None:
                    ...
                    # keyboard option.
                    keyboards = (
                        babase.app.meta.scanresults.exports_by_name("bauiv1.Keyboard")
                    ...
                    if len(keyboards) > 1:
                        _bauiv1.textwidget(
                            ...
                            position=(210, v - 70),
                            size=(key_width * 6.1, key_height + 15),
                            text=babase.Lstr(resource="keyboardChangeInstructionsText"),
                            scale=0.75,
                        )
    ...
    def _get_keyboard(self) -> bui.Keyboard:
        ...
        classname = babase.app.meta.scanresults.exports_by_name("bauiv1.Keyboard")[
    ...
    def _next_keyboard(self) -> None:
        assert babase.app.meta.scanresults is not None
        kbexports = babase.app.meta.scanresults.exports_by_name("bauiv1.Keyboard")
    ...
    def _type_char(self, char: str) -> None:
        self._click_sound.play()
        if char.isspace():
            if babase.apptime() - self._last_space_press < self._double_space_interval:
    ...
    def _done(self) -> None:
        _bauiv1.containerwidget(edit=self._root_widget, transition="out_scale")
        self._adapter.apply(cast(str, _bauiv1.textwidget(query=self._text_field)))
